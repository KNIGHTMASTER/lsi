...
public interface ICityClient {
    ...
    @RequestLine("POST /secured/city/findById")
    GenericSingleDATAResponseDTO<ResponseCityDTO> findCityById(@Param("auth") String p_BearerToken, RequestFindByIdDTO p_RequestFindByIdDTO);
}
