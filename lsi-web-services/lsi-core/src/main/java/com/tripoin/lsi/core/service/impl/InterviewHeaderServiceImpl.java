...
import com.tripoin.lsi.core.client.impl.ProvinceClientImpl;
...
import com.tripoin.lsi.core.data.mapper.*;
import com.tripoin.lsi.core.data.model.*;
import com.tripoin.lsi.core.formula.FormulaInterviewCompletion;
import com.tripoin.lsi.core.formula.FormulaInterviewValidity;
            ...
            if (interviewHeaders != null) {
                ...
                for (InterviewHeader interviewHeader : interviewHeaders.getContent()) {
                    ...
                    Integer numberOfCompletedInterview = interviewDetailService.countInterviewDetailByInterviewHeaderIdAndInterviewStatus(
                            interviewHeader.getId(), LsiCoreConstant.InterviewStatus.COMPLETED
                    );
