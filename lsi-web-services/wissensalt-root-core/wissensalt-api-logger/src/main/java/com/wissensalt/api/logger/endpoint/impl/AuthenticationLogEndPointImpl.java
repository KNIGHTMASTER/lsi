 ...
 */
@RestController
@RequestMapping("/api/authenticationLog")
public class AuthenticationLogEndPointImpl implements ILogEndPoint<RequestAuthenticationLogDTO> {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(AuthenticationLogEndPointImpl.class);

    @Override
    public void insert(@RequestBody RequestAuthenticationLogDTO p_DATA) throws APILoggerEndPointException {
