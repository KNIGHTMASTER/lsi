...
import com.tripoin.lsi.thirdparty.dao.IInterviewComponentDAO;
import com.tripoin.lsi.thirdparty.data.dto.request.ContentInsertComponentDTO;
import com.tripoin.lsi.thirdparty.data.dto.request.ContentInsertQuestionAnswerDTO;
import com.tripoin.lsi.thirdparty.data.dto.request.RequestInsertComponentDTO;
import com.tripoin.lsi.thirdparty.data.dto.request.RequestInterviewComponentDTO;
import com.tripoin.lsi.thirdparty.data.dto.response.ContentQuestionDTO;
import com.tripoin.lsi.thirdparty.data.dto.response.ResponseDetailComponentDTO;
import com.tripoin.lsi.thirdparty.data.mapper.QuestionAnswerMapper;
import com.tripoin.lsi.thirdparty.data.mapper.StatementImageMapper;
                            ...
                            if (question != null) {
                                ...
                                if (componentDTO.getQuestions().getQuestionAnswers() != null) {
                                    if (componentDTO.getQuestions().getQuestionAnswers().size() > 0) {
                                        question.setQuestionType(LsiThirdPartyConstant.QuestionType.MULTIPLE_CHOICE);
                                        ...
                                        question.setQuestionType(LsiThirdPartyConstant.QuestionType.ESSAY);
