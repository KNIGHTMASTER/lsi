...
import com.tripoin.lsi.thirdparty.dao.IInterviewDetailDAO;
...
public class InterviewDetailServiceImpl extends AScaffoldingService<InterviewDetail, RequestInterviewDetailDTO> implements IInterviewDetailService {
    ...
    public List<InterviewDetail> findByInterviewHeaderIdAndValidityStatusNotValid(Long p_InterviewHeaderId) throws ServiceException {
        try {
            return interviewDetailDAO.findByInterviewHeader_idAndNotEqualValidityStatus(p_InterviewHeaderId, LsiThirdPartyConstant.ValidityStatus.NOT_VALID);
        } catch (DAOException e) {
            LOGGER.error("Error Searching Interview Detail by Header Id and Validity Status {}", e.toString());
            return null;
        }
    ...
    public Page<InterviewDetail> findByInterviewHeaderIdAndValidityStatusNotValid(List<Long> interviewHeaders, Pageable p_PageRequest) throws ServiceException {
        try {
            return interviewDetailDAO.findByInterviewHeader_idInAndValidityStatusNot(interviewHeaders, LsiThirdPartyConstant.ValidityStatus.NOT_VALID, p_PageRequest);
        } catch (DAOException e) {
...
//                            responseData = new ResponseData(EResponseCode.RC_FAILURE.getResponseCode(), "Error Parsing End Time");
            ...
            if (p_RequestInsertInterviewDetailResultDTO.getEvidenceImagePath().size() > 0) {
                ...
                interviewDetail.setInterviewStatus(LsiThirdPartyConstant.InterviewStatus.COMPLETED);
            }else {
                interviewDetail.setInterviewStatus(LsiThirdPartyConstant.InterviewStatus.NOT_COMPLETED);
            }
    ...
    private String getValidityStatus(Integer p_InterviewScore) {
        if (p_InterviewScore >= 0 && p_InterviewScore <= 25) {
            return LsiThirdPartyConstant.ValidityStatus.NOT_VALID;
        }else if (p_InterviewScore > 25 && p_InterviewScore <= 50) {
            return LsiThirdPartyConstant.ValidityStatus.LESS_VALID;
        }else if (p_InterviewScore > 50 && p_InterviewScore <= 75) {
            return LsiThirdPartyConstant.ValidityStatus.VALID_ENOUGH;
        }else if (p_InterviewScore > 75) {
            return LsiThirdPartyConstant.ValidityStatus.VALID;
        }else {
            return LsiThirdPartyConstant.ValidityStatus.NOT_VALID;
        }
    }
            ...
            if (p_RequestFilterInterviewHeader.getBranchId() != null) {
                ...
                if (p_RequestFilterInterviewHeader.getProvinceId() != null && p_RequestFilterInterviewHeader.getCityId() == null && p_RequestFilterInterviewHeader.getDistrictId() == null && p_RequestFilterInterviewHeader.getVillageId() == null) {
                    try {
                        ...
                        result = interviewDetailDAO.findByProvinceIdAndBranchIdAndInterviewEvent_Id(p_RequestFilterInterviewHeader.getProvinceId(), p_RequestFilterInterviewHeader.getBranchId(), p_RequestFilterInterviewHeader.getInterviewEventId(), LsiThirdPartyConstant.InterviewStatus.COMPLETED, 25);
                    } catch (DAOException e) {
                ...
                if (p_RequestFilterInterviewHeader.getProvinceId() == null && p_RequestFilterInterviewHeader.getCityId() == null && p_RequestFilterInterviewHeader.getDistrictId() == null && p_RequestFilterInterviewHeader.getVillageId() == null && p_RequestFilterInterviewHeader.getInterviewEventId() != null) {
                    try {
                        ...
                        result = interviewDetailDAO.findByBranchIdAndInterviewEvent_Id(p_RequestFilterInterviewHeader.getBranchId(), p_RequestFilterInterviewHeader.getInterviewEventId(), LsiThirdPartyConstant.InterviewStatus.COMPLETED, 25);
                    } catch (DAOException e) {
                ...
                if (p_RequestFilterInterviewHeader.getProvinceId() != null && p_RequestFilterInterviewHeader.getCityId() == null && p_RequestFilterInterviewHeader.getDistrictId() == null && p_RequestFilterInterviewHeader.getVillageId() == null) {
                    try {
                        LOGGER.info("Find By Province Id");
                        result = interviewDetailDAO.findByProvinceIdAndInterviewEvent_Id(p_RequestFilterInterviewHeader.getProvinceId(), p_RequestFilterInterviewHeader.getInterviewEventId(), LsiThirdPartyConstant.InterviewStatus.COMPLETED, 25);
                    } catch (DAOException e) {
                        LOGGER.error("Error Search Int Header By Province {}", e.toString());
                    }
                }
                if (p_RequestFilterInterviewHeader.getProvinceId() != null && p_RequestFilterInterviewHeader.getCityId() != null && p_RequestFilterInterviewHeader.getDistrictId() == null && p_RequestFilterInterviewHeader.getVillageId() == null && p_RequestFilterInterviewHeader.getInterviewEventId() != null) {
                    try {
                        LOGGER.info("Find By Province And City Id");
                        result = interviewDetailDAO.findByProvinceIdAndCityIdAndInterviewEvent_Id(p_RequestFilterInterviewHeader.getProvinceId(), p_RequestFilterInterviewHeader.getCityId(), p_RequestFilterInterviewHeader.getInterviewEventId(), LsiThirdPartyConstant.InterviewStatus.COMPLETED, 25);
                    } catch (DAOException e) {
                        LOGGER.error("Error Search Int Header By Province And City {}", e.toString());
                    }
                }
                if (p_RequestFilterInterviewHeader.getProvinceId() != null && p_RequestFilterInterviewHeader.getCityId() != null && p_RequestFilterInterviewHeader.getDistrictId() != null && p_RequestFilterInterviewHeader.getVillageId() == null && p_RequestFilterInterviewHeader.getInterviewEventId() != null) {
                    try {
                        LOGGER.info("Find By Province City and District Id");
                        result = interviewDetailDAO.findByProvinceIdAndCityIdAndDistrictIdAndInterviewEvent_Id(p_RequestFilterInterviewHeader.getProvinceId(), p_RequestFilterInterviewHeader.getCityId(), p_RequestFilterInterviewHeader.getDistrictId(), p_RequestFilterInterviewHeader.getInterviewEventId(), LsiThirdPartyConstant.InterviewStatus.COMPLETED, 25);
                    } catch (DAOException e) {
                        LOGGER.error("Error Search Int Header By Province And City And District {}", e.toString());
                    }
                }
                if (p_RequestFilterInterviewHeader.getProvinceId() != null && p_RequestFilterInterviewHeader.getCityId() != null && p_RequestFilterInterviewHeader.getDistrictId() != null && p_RequestFilterInterviewHeader.getVillageId() != null && p_RequestFilterInterviewHeader.getInterviewEventId() != null) {
                    try {
                        LOGGER.info("Find By Province City District and Village Id");
                        result = interviewDetailDAO.findByProvinceIdAndCityIdAndDistrictIdAndVillageIdAndInterviewEvent_Id(p_RequestFilterInterviewHeader.getProvinceId(), p_RequestFilterInterviewHeader.getCityId(), p_RequestFilterInterviewHeader.getDistrictId(), p_RequestFilterInterviewHeader.getVillageId(), p_RequestFilterInterviewHeader.getInterviewEventId(), LsiThirdPartyConstant.InterviewStatus.COMPLETED, 25);
                    } catch (DAOException e) {
                        LOGGER.error("Error Search Int Header By Province {}", e.toString());
                    }
                }
                if (p_RequestFilterInterviewHeader.getProvinceId() == null && p_RequestFilterInterviewHeader.getCityId() == null && p_RequestFilterInterviewHeader.getDistrictId() == null && p_RequestFilterInterviewHeader.getVillageId() == null && p_RequestFilterInterviewHeader.getInterviewEventId() != null) {
                    try {
                        ...
                        result = interviewDetailDAO.findByInterviewEvent_Id(p_RequestFilterInterviewHeader.getInterviewEventId(), LsiThirdPartyConstant.InterviewStatus.COMPLETED, 25);
                    } catch (DAOException e) {
                        LOGGER.error("Error Search Int Header By Event Only {}", e.toString());
                    }
                }
